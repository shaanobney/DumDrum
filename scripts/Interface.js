...
Interface.Dial = function(params){

	if (this instanceof Interface.Dial){
		...
		return new Interface.Dial(params);
	}
};

Interface.Dial.prototype.value = function(val){
	var maxSize = this.container[this.maxAxis]() - this.element[this.maxAxis]();
	//y gets inverted
	if (this.axis === "y"){
		maxSize = this.container[this.maxAxis]() - maxSize;
...
Interface.Dial.prototype._ondrag = function(e, pointer){
	if (typeof this.top === "undefined"){
		this.top = this.container.offset().top;
		this.left = this.container.offset().left;
	}
...
Interface.Dial.prototype._onstart = function(e){
	e.preventDefault();
	if (this.start){
		this.start();
	}
...
Interface.Dial.prototype._onend = function(){
	if (this.end){
		this.end();
	}
};

Interface.Dial.prototype._setParam = function(value){
	if (this.parameter && this.tone){
		this.tone.set(this.parameter, value);
	}
};
